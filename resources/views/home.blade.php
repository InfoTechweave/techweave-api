            ...
            <div class="team-section-1-parent upcoming-matches">
                ...
                <ul>
                    @foreach ($matches['data']['matches'] as $match)
                        <li>
                            <strong>Key:</strong> {{ $match['key'] }}<br>
                            <strong>Match:</strong> {{ $match['name'] }}<br>
                            <strong>Short Name:</strong> {{ $match['short_name'] }}<br>
                            <strong>Start Time:</strong> {{ date('Y-m-d H:i:s', $match['start_at']) }}<br>
                            <strong>Status:</strong> {{ $match['status'] }}<br>
                            <strong>Format:</strong> {{ strtoupper($match['format']) }}<br>
                            <strong>Venue:</strong> {{ $match['venue']['name'] }}, {{ $match['venue']['city'] }}, {{ $match['venue']['country']['name'] }}<br>
                            <strong>Teams:</strong> {{ $match['teams']['a']['name'] }} vs. {{ $match['teams']['b']['name'] }}<br>
